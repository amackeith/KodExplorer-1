...
>
>  Docker: docker build -t kod .  Then: docker run --rm -it --privileged -p 80:80 -v /AnyFolderYouWant/:/var/www/html/data/User/guest/home  kod:latest Last: on browser go to localhost
>
>
